...
const topics = [
  {
    ...
    description: "Interior, Architecture, Workflows, and advanced 3D techniques.",
    icon: Box,
    count: 11,
  ...
  },
  {
    slug: "ai-in-3d",
    title: "AI in 3D",
    description: "Neural Rendering, Generative AI for Textures, and intelligent automation.",
    icon: Brain,
    count: 1,
  ...
  },
  {
    ...
    description: "AWS vs Edge, Runpod, Multi-GPU setups, and infrastructure automation.",
    icon: Cloud,
    count: 1,
  ...
  },
  {
    slug: "depin",
    title: "DePIN Compute",
    description: "Decentralized Compute, Future of GPU networks, and Cost saving analysis.",
    icon: Globe,
    count: 1,
  ...
  },
  {
    ...
    description: "WebGPU, AR/VR integration, Web3D, and immersive technologies.",
    icon: Atom,
    count: 1,
  ...
  },
  {
    slug: "digital-twins",
    title: "Digital Twins",
    description: "Industrial 3D, BIM Integration, Smart Cities, and virtual replicas.",
    icon: Building2,
    count: 1,
  ...
  },
  {
    ...
    description: "Energy-efficient rendering, green computing, and carbon-neutral workflows.",
    icon: Leaf,
    count: 1,
